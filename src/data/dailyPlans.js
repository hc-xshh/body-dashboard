...
const eveningRoutine = {
  周一: {
    theme: '三酸精华夜',
    duration: '约 10-15 分钟',
    steps: ['清透洁面', '收敛水', '三酸精华', 'MELA B3 美白精华', 'B5局部点涂（可选）', '水油平衡乳'],
    note: '属于功效夜，注意避开眼周。',
  },
  周二: {
    theme: '停三酸修护夜',
    duration: '约 8-12 分钟',
    steps: ['清透洁面', '收敛水', 'MELA B3 美白精华', 'B5局部点涂（可选）', '水油平衡乳'],
    note: '给皮肤留恢复窗口。',
  },
  周三: {
    theme: '深度清洁夜',
    duration: '约 40-50 分钟',
    steps: ['清透洁面', '白泥面膜 10-15 分钟', '清痘面膜 15-20 分钟', '收敛水', 'MELA B3 美白精华', 'B5局部点涂（可选）', '水油平衡乳'],
  ...
  周日: {
    theme: '停三酸修护夜',
    duration: '约 8-12 分钟',
    steps: ['清透洁面', '收敛水', 'MELA B3 美白精华', 'B5全脸薄涂（可选）', '水油平衡乳'],
    note: '休息日以修护为主。',
  },
}
