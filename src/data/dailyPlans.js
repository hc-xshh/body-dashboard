...
const trainingPlans = {
  周一: {
    ...
    items: [
      ...
      { title: '主训练', time: '约 25-35 分钟', steps: ['俯卧撑（手放哑铃上）3×10-15，60-90秒', '哑铃推举（坐姿）3×12，60-90秒', '哑铃侧平举 3×15，45-60秒', '钻石俯卧撑 3×8-12，60-90秒', '俯身哑铃划船 3×12/臂，60-90秒'] },
      { title: '腹肌', time: '训练后', steps: ['哑铃卷腹 3×15，45-60秒'] },
  ...
  周二: {
    ...
    items: [
      ...
      { title: '主训练', time: '约 30-40 分钟', steps: ['高脚杯深蹲（壶铃）4×12，75-90秒', '保加利亚分腿蹲 3×10/腿，75-90秒', '箭步蹲（手持哑铃）3×8/腿，60-75秒', '罗马尼亚硬拉（哑铃）3×12，75-90秒', '壶铃摆荡 3×15-20，45-60秒', '平板支撑 3×45秒，45-60秒', '死虫式 3×10/侧，30-45秒'] },
      { title: '腹肌', time: '训练后', steps: ['反向卷腹 3×12，45-60秒'] },
  ...
  周四: {
    ...
    items: [
      ...
      { title: '主训练', time: '约 25-35 分钟', steps: ['俯身宽握哑铃划船 4×12，60-90秒', '单臂哑铃划船 3×12/臂，60-90秒', '双手哑铃俯身划船 3×15，60-75秒', '哑铃弯举 3×15，45-60秒', '锤式弯举 3×12，45-60秒'] },
      { title: '腹肌', time: '训练后', steps: ['俄罗斯转体（持哑铃）3×20，45-60秒'] },
  ...
  周五: {
    ...
    items: [
      ...
      { title: '主训练', time: '约 20-30 分钟', steps: ['阿诺德推举 3×12，60-75秒', '哑铃前平举 3×12，45-60秒', '俯身哑铃飞鸟 3×15，45-60秒'] },
      { title: '腹肌专项', time: '15 分钟', steps: ['卷腹 3×15，45-60秒', '反向卷腹 3×15，45-60秒', '俄罗斯转体 3×20，45-60秒', '侧平板支撑 3×30秒/侧，30-45秒', '平板支撑 2×60秒，45-60秒'] },
